		...
		<>
			...
			<main>
				<section className="px-8">
					<h2
						id="master"
						className="my-4 font-roboto-flex text-3xl text-center font-black italic text-green-900 scroll-mt-10 md:scroll-mt-12"
						data-aos="fade-down">
				...
				<section className="px-8 mb-8">
					<h2
						className="font-roboto-flex text-2xl sm:text-3xl text-center font-black italic text-green-900 mb-4"
						data-aos="fade-down">
				...
				<section className="px-8 mb-8">
					<h2
						className="font-roboto-flex text-3xl text-center font-black italic text-green-900 mb-4"
						data-aos="fade-down">
						{t("Uniforme")}
					</h2>
